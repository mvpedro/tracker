  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-background fixed z-50 flex flex-col gap-4 overflow-y-auto px-6 py-2 shadow-lg',
          side === 'right' &&
            'inset-y-0 right-0 h-full w-full border-l sm:w-5/6 sm:max-w-lg',
          side === 'left' &&
            'inset-y-0 left-0 h-full w-full border-r sm:w-5/6 sm:max-w-lg',
